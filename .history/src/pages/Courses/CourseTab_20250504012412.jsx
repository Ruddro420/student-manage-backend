...
const CourseTab = ({ course, updateData }) => {
    ...
    return (
        <div>
            ...
            <div className="rounded-xl dark:text-white p-1 mb-3 max-w-full overflow-hidden">
                <ul className="flex py-4 items-center gap-2 text-sm font-medium flex-wrap">
                    ...
                    <li>
                        <a
                            ...
                            className={`inline-flex cursor-pointer items-center gap-2 rounded border px-3 py-2 dark:bg-gray-800 dark:text-white hover:shadow ${activeTab === 6 ? 'tab-color shadow' : ''}`}>
                            পেমেন্ট  
                        </a>
                    </li>
                </ul>
            ...
            <div className="py-3 lg:px-0 px-2">
                ...
                <div className={`${activeTab === 6 ? 'block' : 'hidden'} transition-opacity duration-600`}>
                    <Payment data={course}  reloadData={updateData}/>
                </div>
            </div>
        </div>
    );
