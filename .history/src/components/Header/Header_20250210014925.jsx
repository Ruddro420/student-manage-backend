                ...
                <div className="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                    ...
                    >
                        <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M3 5h12a1 1 0 110 2H3a1 1 0 110-2zM3 10h12a1 1 0 110 2H3a1 1 0 110-2zM3 15h12a1 1 0 110 2H3a1 1 0 110-2z" clipRule="evenodd"></path>
                        </svg>
                    </button>
                    ...
                    <div className="py-4 text-gray-500 dark:text-gray-400">
                        ...
                        <ul className="mt-6">
                            <li className="relative px-2 py-3">
                                <Link className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 dark:hover:text-gray-200 dark:text-gray-100 p-3" to="/dashboard">
                                    <span className="ml-4">আমার কোর্স</span>
                                </Link>
                            </li>
                            <li className="relative px-2 py-3">
                                <Link className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 dark:hover:text-gray-200 p-3" to="/dashboard/performances">
                                    <span className="ml-4">পারফর্মেন্স</span>
                                </Link>
                            </li>
                            <li className="relative px-2 py-3">
                                <button className="w-full text-left text-sm font-semibold p-3 text-red-500 hover:bg-gray-200 dark:hover:bg-gray-700 rounded" onClick={handleLogout}>
                                    Logout
                                </button>
                            </li>
                        </ul>
