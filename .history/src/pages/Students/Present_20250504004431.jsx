...
const Present = ({ data, reloadData }) => {
    ...
    const presentData = (id, courseId) => {
        if (date == '') {
            ...
            axios
                ...
                .then((res) => {
                    toast.success(id + " present successfully!");
                    getStudentData();
                })
                .catch((error) => {
                    console.log(error);
    ...
    const absentData = (id, courseId) => {
        if (date == '') {
            ...
            axios
                .post(`${BASE_URL}/student/present/absent/data`, {
                    s_id: id,
                    date: date,
                    status: 1,
                })
                                        ...
                                        >
                                            ...
                                            <td className="w-1/3">
                                                <div className="flex gap-5">
                                                    <button
                                                        onClick={() =>
                                                            presentData(item.ex_1, item.courseId)
                                                        }
                                                        className="flex items-center bg-[#ff2ded] text-white px-5 rounded-md my-3 cursor-pointer p-2 hover:bg-[black]"
                                                    ...
                                                    <div
                                                        onClick={() =>
                                                            absentData(item.ex_1, item.courseId)
                                                        }
