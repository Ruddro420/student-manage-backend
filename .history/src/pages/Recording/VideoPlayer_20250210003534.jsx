...
const VideoPlayer = () => {
    ...
    useEffect(() => {
        axios.get(`${BASE_URL}/recording/specificData/${id}`)
            .then((res) => {
                const foundData = res.data?.recording?.[0] || {}; // Ensure it's an object
                setGetData(foundData); // ✅ Set state properly
            ...
            .catch((error) => {
                ...
                setGetData({}); // Set empty object on error
            });
    }, [id]);
    ...
    return (
        <div className="container px-6 mx-auto grid">
            <h2 className="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                <b>ক্লাস টপিকসঃ</b> {getData.record_name}
            </h2>
            <hr />
