  ...
  return (
    <div className="mb-10 dark:bg-gray-800 bg-white p-5 shadow-sm rounded">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className="block px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[black] border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
          Add Resource
        </button>
      </form>
    </div>
