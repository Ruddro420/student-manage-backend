      ...
      {assingments?.length != 0 ? (
        <>
          <div className="module-container">
            {
              assingments.map(item => <><div key={item.id} className="p-3 border dark:bg-gray-800 rounded-lg mb-2 mt-5 bg-[#1D2939] text-white">
                <h1>{item.module_name}</h1>
              </div><div className="w-full overflow-hidden rounded-lg shadow-xs">
